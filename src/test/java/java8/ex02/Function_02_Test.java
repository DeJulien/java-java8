...
public class Function_02_Test {
    ...
    BiFunction<Person, Integer, Account> buildAccount = (Person p, Integer t) -> {
			// TODO Auto-generated method stub
			Account temps = new Account();
			temps.setOwner(p);
			temps.setBalance(500);
			return temps;
		};
    //  end::buildAccount[]
    ...
    public void test_build_account() throws Exception {
    	...
    	Person pTemp = new Person("John","France",80,"pass");
        Account account = buildAccount.apply(pTemp, 500);
