...
public class DateAndTime_02_Test {
    ...
    public void test_localDate_format() {
        ...
        String result = localDate.getDayOfMonth()+" - "+localDate.getMonthValue()+" - "+localDate.getYear();
    ...
    public void test_with() {
        ...
        LocalDate result = localDate.of(localDate.getYear()+15, localDate.getMonthValue()+1, localDate.getDayOfMonth()-5);
