...
public class Lambda_01_Test {
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        PersonPredicate personPre = (p) ->  p.getFirstname().equals("first_10");
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate personPre = (p) -> p.getAge()>49 && DigestUtils.sha512Hex(p.getPassword()).equals(passwordSha512Hex);
